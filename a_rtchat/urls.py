...
urlpatterns = [
    ...
    path('chat/private/settings/<chatroom_name>', private_room_settings_update, name='private-room-settings'),
    ...
    path('chat/private/waiting/<chatroom_name>/leave/', code_room_waiting_leave, name='code-room-waiting-leave'),
    ...
    path('chat/room/<chatroom_name>/member/make-admin/<int:user_id>/', chatroom_member_make_admin_view, name='chatroom-member-make-admin'),
    path('chat/room/<chatroom_name>/member/remove-admin/<int:user_id>/', chatroom_member_remove_admin_view, name='chatroom-member-remove-admin'),
    path('chat/room/<chatroom_name>/member/mute/<int:user_id>/', chatroom_member_mute_view, name='chatroom-member-mute'),
    path('chat/room/<chatroom_name>/member/invite/', chatroom_member_invite_view, name='chatroom-member-invite'),
    path('chat/invite/<token>/', chatroom_invite_accept_view, name='chatroom-invite-accept'),
